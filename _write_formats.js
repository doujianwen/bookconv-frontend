...
const dir = path.join(root, 'src/app/formats/[format]');
...
const pageLines = [
  ...
  "      description,",
  "      type: 'article',",
  "      url: https://bookconv.com/formats/,",
  "      siteName: 'BookConv',",
  "    },",
  "  }",
  "}",
...
fs.writeFileSync(path.join(dir, 'page.tsx'), pageLines.join('\n'), 'utf8');
console.log('page.tsx written:', pageLines.length, 'lines');

// FormatPageClient.tsx content
const clientLines = [
  "'use client'",
  "import Link from 'next/link'",
...
fs.writeFileSync(path.join(dir, 'FormatPageClient.tsx'), clientLines.join('\n'), 'utf8');
console.log('FormatPageClient.tsx written:', clientLines.length, 'lines');
