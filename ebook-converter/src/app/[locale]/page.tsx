...
const TOP_CONVERTERS = [
  ...
  { label: "EPUB to AZW3", href: "/convert/epub-to-azw3" },
  { label: "EPUB to DOC", href: "/convert/epub-to-doc" },
...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      {/* Popular conversions — SEO internal-link hub (P1: concentrate
          homepage authority onto the high-value convert pages) */}
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-5xl px-4">
          <h2 className="mb-8 text-center text-2xl font-bold text-gray-900">Popular Conversions</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {TOP_CONVERTERS.map((c) => (
              <Link key={c.href} href={c.href} className="rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:border-blue-300 hover:text-blue-600">
                {c.label}
              </Link>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              { icon: Globe, title: 'No Account Needed', desc: 'Convert ebooks for free — no registration or software install required.' },
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-4xl px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/convert/epub-to-azw3" className="group block rounded-xl border border-gray-200 p-4 transition-all hover:border-blue-300 hover:shadow-md">
                <div className="aspect-video rounded-lg bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
                  <span className="text-white text-4xl">▶</span>
                </div>
                <h3 className="font-semibold text-gray-900">EPUB → AZW3</h3>
                <p className="text-sm text-gray-500 mt-1">Kindle-native AZW3 from any EPUB in one click.</p>
              </Link>
              <Link href="/convert/epub-to-doc" className="group block rounded-xl border border-gray-200 p-4 transition-all hover:border-blue-300 hover:shadow-md">
                <div className="aspect-video rounded-lg bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
                  <span className="text-white text-4xl">▶</span>
                </div>
                <h3 className="font-semibold text-gray-900">EPUB → DOC</h3>
                <p className="text-sm text-gray-500 mt-1">Turn an EPUB into an editable Word document.</p>
              </Link>
            </div>
          </div>
        </section>
