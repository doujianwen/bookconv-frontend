...
export const content = {
  ...
  sections: [
    ...
    { heading: "Batch and Large File Workflows", body: `For libraries with many files or large scanned PDFs, single-file converters fall short. Our [batch converter guide](/guide/batch-converter) covers Calibre-based workflows for bulk jobs, and the [large file conversion guide](/blog/large-file-conversion-guide) explains how to handle files over 10 MB without hitting size limits.` }
  ]
};
