...
export const tags = ['LIT', 'EPUB', '微软阅读器', '数据迁移'];

export const content = {
  intro: '微软在 2011 年正式停止了对 Microsoft Reader 的支持，这意味着数百万 LIT 格式的电子书文件已经变成了"数字孤儿"。本指南将告诉你为什么现在就应该把 LIT 文件转换成 EPUB。',
  sections: [
    {
      heading: 'LIT 格式的现状',
