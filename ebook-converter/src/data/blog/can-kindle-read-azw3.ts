...
- **Convert first** — if your book starts as EPUB, [convert EPUB to AZW3](/convert/epub-to-azw3) in the browser, then sideload. For the full step-by-step on getting the best result without losing formatting, see our [EPUB to AZW3 for Kindle guide](/guide/epub-to-azw3-for-kindle).
