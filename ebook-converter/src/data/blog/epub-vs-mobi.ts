...
export const title = `EPUB vs MOBI: Which Ebook Format Should You Actually Use? (2026)`;
...
Amazon has since moved its Kindles to **AZW3** (KF8), a much richer format, and removed MOBI from Send to Kindle back in **August 2022**. So MOBI today is mostly a compatibility format for readers who still own a pre-2015 Kindle. New books are not being authored in MOBI.

**KFX note:** Amazon's current store format (KFX) is even more advanced than AZW3, with enhanced typesetting features. But KFX is generated by Amazon's own pipeline — you can't create it yourself. For sideloading or conversion, AZW3 remains the practical target.`
    },
    {
...
export const faqs = [
  ...
  },
  {
    ...
    answer: `Not for new books. Amazon moved Kindles to AZW3 (KF8) and removed MOBI from Send to Kindle in August 2022. MOBI now survives mainly as a compatibility format for readers who still own pre-2015 Kindle hardware. Amazon's current store format KFX is even more advanced, but it's Amazon-only and can't be created by third-party tools.`,
  },
  {
