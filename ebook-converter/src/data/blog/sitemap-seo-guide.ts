...
- **Keep robots.txt consistent** with the sitemap, and name the sitemap inside robots.txt so - **Use honest metadata.** Real last-modified dates and differentiated priorities carry signal; identical values everywhere carry none. For deeper technical SEO guidance on internal linking structure, see our [ebook troubleshooting guide](/blog/ebook-troubleshooting).`
    }
  ]
};
