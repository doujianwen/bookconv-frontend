  ...
  sections: [
    {
      ...
      body: '**Backlight-Free Reading** — Old Kindles and basic e-ink devices read TXT files smoothly. **Text Analysis** — Clean text is ideal for NLP processing, word frequency analysis, and sentiment analysis. **AI Summarization** — Feed clean text to AI tools for automatic summaries and insights. **Translation** — Plain text translates more accurately than formatted documents. **Maximum Compatibility** — Any text editor, note app, or code tool can open TXT files.'
    },
    {
