...
If you are choosing between a desktop tool and an online converter, see [/guide/calibre-vs-online-converter](/guide/calibre-vs-online-converter).`,
    ...
    {
      heading: 'EPUB to AZW3 or KFX for Kindle Scribe?',
      body: `Kindle Scribe reads AZW3, KFX, and EPUB. If you convert your own EPUB, AZW3 is the safe target: tools like BookConv produce it reliably and Scribe displays it cleanly.

KFX is Amazon's newer format with extra layout features, but standard converters do not generate true KFX — only Amazon's own pipeline does. So if you want a file you created yourself, convert to AZW3. If you instead send the EPUB through Send to Kindle, Amazon may deliver it as KFX with its enhanced features. Either way, start from your EPUB; you do not need to hand-build KFX.`
    },
    {
