...
export const title = 'DJVU to PDF: Turn Scanned Books into a Shareable PDF'
export const problem = 'You have a scanned book in DJVU that no reader app opens and no one can print. Converting DJVU to PDF makes it readable everywhere. Here is how to do it without losing quality.'
