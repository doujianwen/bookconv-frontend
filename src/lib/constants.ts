...
export const KEYWORDS: KeywordData[] = [
  ...
  { source: 'pdf', target: 'epub', keyword: 'pdf to epub converter', kd: 78, searchVolume: 12100, phase: 'P0', status: 'live' },
  { source: 'docx', target: 'epub', keyword: 'docx to epub converter', kd: 55, searchVolume: 3600, phase: 'P0', status: 'live' },
  { source: 'epub', target: 'mobi', keyword: 'epub to mobi converter', kd: 60, searchVolume: 8100, phase: 'P0', status: 'live' },
  { source: 'epub', target: 'azw3', keyword: 'epub to azw3 converter', kd: 52, searchVolume: 4400, phase: 'P0', status: 'live' },
  { source: 'txt', target: 'epub', keyword: 'txt to epub converter', kd: 45, searchVolume: 2900, phase: 'P0', status: 'live' },
  ...
  { source: 'azw3', target: 'pdf', keyword: 'azw3 to pdf converter', kd: 40, searchVolume: 1900, phase: 'P0', status: 'live' },
  { source: 'azw3', target: 'mobi', keyword: 'azw3 to mobi converter', kd: 38, searchVolume: 2400, phase: 'P0', status: 'live' },
  { source: 'fb2', target: 'epub', keyword: 'fb2 to epub converter', kd: 30, searchVolume: 1300, phase: 'P0', status: 'live' },
  { source: 'lit', target: 'epub', keyword: 'lit to epub converter', kd: 32, searchVolume: 1600, phase: 'P0', status: 'live' },
  { source: 'doc', target: 'epub', keyword: 'doc to epub converter', kd: 42, searchVolume: 2400, phase: 'P0', status: 'live' },
  { source: 'cbr', target: 'pdf', keyword: 'cbr to pdf converter', kd: 28, searchVolume: 1300, phase: 'P0', status: 'live' },
  { source: 'djvu', target: 'pdf', keyword: 'djvu to pdf converter', kd: 25, searchVolume: 1000, phase: 'P0', status: 'live' },
